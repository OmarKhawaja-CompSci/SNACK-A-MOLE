...
public class LoginPage extends JPanel {
    ...
    public LoginPage(CardLayout cardLayout, JPanel cards) {
        ...
        springLayout.putConstraint(SpringLayout.EAST, login, startX + maxLabelWidth + gap + uniformFieldWidth +75, SpringLayout.WEST, this);
        
        // ---- NAME ----
        springLayout.putConstraint(SpringLayout.WEST, name, startX+80, SpringLayout.WEST, this);
        springLayout.putConstraint(SpringLayout.NORTH, name, currentY, SpringLayout.NORTH, this);

        springLayout.putConstraint(SpringLayout.WEST, enterName, startX + maxLabelWidth + gap+80, SpringLayout.WEST, this);
        springLayout.putConstraint(SpringLayout.NORTH, enterName, currentY, SpringLayout.NORTH, this);

        // ---- PASSWORD ----
        currentY += verticalSpacing;

        springLayout.putConstraint(SpringLayout.WEST, passwordLabel, startX+80, SpringLayout.WEST, this);
        springLayout.putConstraint(SpringLayout.NORTH, passwordLabel, currentY, SpringLayout.NORTH, this);

        springLayout.putConstraint(SpringLayout.WEST, enterPassword, startX +80 + maxLabelWidth + gap, SpringLayout.WEST, this);
