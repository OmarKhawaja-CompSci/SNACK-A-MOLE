...
public class SignupPage extends JPanel {
    ...
    public SignupPage(CardLayout cardLayout, JPanel cards) {
        ...
        register.setFont(new Font("Arial", Font.BOLD, 70));
        ...
        layout.putConstraint(SpringLayout.EAST, register, labelX + labelWidth+345, SpringLayout.WEST, this);
        ...
        layout.putConstraint(SpringLayout.EAST, email, labelX + labelWidth+80, SpringLayout.WEST, this);
        layout.putConstraint(SpringLayout.NORTH, insertEmail, startY, SpringLayout.NORTH, this);
        layout.putConstraint(SpringLayout.WEST, insertEmail, fieldX+80, SpringLayout.WEST, this);
        ...
        layout.putConstraint(SpringLayout.EAST, name, labelX + labelWidth+80, SpringLayout.WEST, this);
        layout.putConstraint(SpringLayout.NORTH, insertName, startY + spacingY, SpringLayout.NORTH, this);
        layout.putConstraint(SpringLayout.WEST, insertName, fieldX+80, SpringLayout.WEST, this);
        ...
        layout.putConstraint(SpringLayout.EAST, password, labelX + labelWidth+80, SpringLayout.WEST, this);
        layout.putConstraint(SpringLayout.NORTH, insertPassword, startY + 2 * spacingY, SpringLayout.NORTH, this);
        layout.putConstraint(SpringLayout.WEST, insertPassword, fieldX+80, SpringLayout.WEST, this);
        ...
        layout.putConstraint(SpringLayout.EAST, confirm, labelX + labelWidth+80, SpringLayout.WEST, this);
        layout.putConstraint(SpringLayout.NORTH, confirmPassword, startY + 3 * spacingY, SpringLayout.NORTH, this);
        layout.putConstraint(SpringLayout.WEST, confirmPassword, fieldX+80, SpringLayout.WEST, this);
